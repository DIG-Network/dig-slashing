...
pub use constants::{
    ...
    MAX_PENDING_SLASHES, MAX_SLASH_PROPOSAL_PAYLOAD_BYTES, MAX_VALIDATORS_PER_COMMITTEE,
    MIN_EFFECTIVE_BALANCE, MIN_SLASHING_PENALTY_QUOTIENT, PROPORTIONAL_SLASHING_MULTIPLIER,
