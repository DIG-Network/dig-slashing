...
- [ ] DSL-017 — verify_attester_slashing NotSlashableByPredicate
...
- [ ] DSL-022 — submit_evidence base_slash = max(bps, quotient)
...
- [ ] DSL-074 — ParticipationFlags bits set/has
...
- [ ] DSL-087 — in_finality_stall threshold (> 4 epochs)
